                ...
                if (o && (l = (o.className.match(e) || [, ""])[1], s = t.languages[l]), s) {
                    ...
                    if (g) {
                        ...
                        if (t.hooks.run("before-highlight", u), r && self.Worker) {
                            ...
                            u.highlightedCode = t.highlight(u.code, u.grammar, u.language), t.hooks.run("before-insert", u), u.element.innerHTML = u.highlightedCode, i && i.call(a), t.hooks.run("after-highlight", u)
                    }
                }
            },
